...
class CxcRemesaRepository extends EntityRepository {
    ...
    public function estadoCuentasCobrar($id_cliente=null, $id_tipofactura=null, $fini='', $ffin=''){
        ...
        GROUP BY c.nombre, f.numero, f.fecha, t.nombre, f.venta_total, f.cobro_total, f.subtotal, f.iva_retenido, cobro_total_sin_detalle, c.agente_retencion
