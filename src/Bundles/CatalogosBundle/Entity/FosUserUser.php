...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Bundles\CatalogosBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Bundles\CatalogosBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Bundles\CatalogosBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Bundles\CatalogosBundle\Entity\FosUserGroup $group)
    {
