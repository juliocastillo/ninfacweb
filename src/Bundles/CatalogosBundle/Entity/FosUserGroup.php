...
class FosUserGroup
{
     ...
     * Add user
     *
     * @param \Bundles\CatalogosBundle\Entity\FosUserUser $user
     * @return FosUserGroup
     */
    public function addUser(\Bundles\CatalogosBundle\Entity\FosUserUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \Bundles\CatalogosBundle\Entity\FosUserUser $user
     */
    public function removeUser(\Bundles\CatalogosBundle\Entity\FosUserUser $user)
    {
