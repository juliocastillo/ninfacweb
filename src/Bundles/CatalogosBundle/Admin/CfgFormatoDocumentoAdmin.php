...
class CfgFormatoDocumentoAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->tab('Datos generales')
                ->with('')
            ->add('interlineado','text',array('label'=>'Interlineado en pixeles px'))    
            ->add('fila1Col1','text',array('label'=>'Tamaño en % de la columna 1 para fila 1'))
            ->add('fila1Col2','text',array('label'=>'Tamaño en % de la columna 2 para fila 1'))
            ->add('fila2Col1')
            ->add('fila2Col2')
            ->add('fila3Col1')
            ->add('fila3Col2')
